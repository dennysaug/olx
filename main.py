...
def main():
    ...
    logins = []
    logins.insert(0, {"login": "seixas.camilla@hotmail.com", "senha": "ccss00007542267"})
    logins.insert(1, {"login": "dennysaugustus@hotmail.com", "senha": "051938.."})    
    logins.insert(2, {"login": "dennysaug@gmail.com", "senha": "051938.."})
